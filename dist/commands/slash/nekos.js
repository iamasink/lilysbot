...
exports.default = {
    data: new SlashCommandBuilder()
        ...
        .addChoices({ name: 'smug', value: 'smug' }, { name: 'woof', value: 'woof' }, { name: '8ball', value: '8ball' }, { name: 'goose', value: 'goose' }, { name: 'cuddle', value: 'cuddle' }, { name: 'slap', value: 'slap' }, { name: 'pat', value: 'pat' }, { name: 'gecg', value: 'gecg' }, { name: 'feed', value: 'feed' }, { name: 'fox girl', value: 'fox_girl' }, { name: 'lizard', value: 'lizard' }, { name: 'neko', value: 'neko' }, { name: 'hug', value: 'hug' }, { name: 'meow', value: 'meow' }, { name: 'kiss', value: 'kiss' }, { name: 'wallpaper', value: 'wallpaper' }, { name: 'tickle', value: 'tickle' }, { name: 'waifu', value: 'waifu' })
        .setRequired(true))
