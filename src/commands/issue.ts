import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ChatInputCommandInteraction, ComponentType, GuildTextBasedChannel, ModalActionRowComponentBuilder, ModalBuilder, SlashCommandBuilder, TextInputBuilder, TextInputStyle } from 'discord.js'
...
export default new ApplicationCommand({
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        ...
        const reportInputDescription = new TextInputBuilder()
            ...
            .setRequired(true)
            .setPlaceholder("Write a description for the issue. What went wrong? What's broken?")
            .setMaxLength(1800)
            .setMinLength(20)
